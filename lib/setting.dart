  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      children: <Widget>[
        ...
        Text(""),
        Text(""),
        SettingsButton(Color.fromARGB(255, 99, 9, 243), "-", -1, WORKTIME, updateSetting),
        TextField(
            style: textStyle,
            controller: txtWork,
            textAlign: TextAlign.center,
            keyboardType: TextInputType.number),
        SettingsButton(Color.fromARGB(255, 7, 152, 236), "+", 1, WORKTIME, updateSetting),
        Text("Short", style: textStyle),
        Text(""),
        Text(""),
        SettingsButton(Color.fromARGB(255, 217, 240, 13), "-", -1, SHORTBREAK, updateSetting),
        TextField(
            style: textStyle,
            textAlign: TextAlign.center,
            controller: txtShort,
